      ...
      >
        <div className='grid w-full max-w-xl grid-cols-2 gap-4 mx-auto'>
          ...
          <LiquidGlassCard
            ...
            borderRadius='24px'
            glowIntensity='none'
            className='col-span-2 p-6 text-white bg-white/20'
          >
          ...
          <LiquidGlassCard
            ...
            borderRadius='24px'
            glowIntensity='none'
            className='rounded-3xl p-6 text-white bg-white/20 '
          >
          ...
          >
            <div className='relative z-30 flex flex-col items-start justify-center h-full w-full'>
              ...
              <button className='mt-4 inline-flex items-center gap-1 rounded-full bg-black/10 backdrop-blur-xl px-2 py-1 text-sm font-medium border border-white/20'>
          ...
          <LiquidGlassCard
            ...
            borderRadius='24px'
            glowIntensity='none'
            className='col-span-2 rounded-3xl bg-white/20 p-6 text-white'
          >
...
export default WeatherLiquidGlassy;
