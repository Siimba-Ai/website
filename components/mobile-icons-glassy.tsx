    ...
    <>
      ...
      >
        <div className='grid grid-cols-4 gap-4 p-6 rounded-3xl '>
          <LiquidGlassCard className='w-16 h-16 rounded-full bg-white/20' shadowIntensity='lg'>
          ...
          <LiquidGlassCard className='w-16 h-40 rounded-full flex items-center justify-center text-white text-2xl row-span-2 bg-white/20' shadowIntensity='lg'>
            <div className='relative z-30 flex items-center justify-center text-white text-2xl w-full h-full '>
          ...
          <LiquidGlassCard className='col-span-2 h-16 rounded-full flex items-center justify-center px-4 gap-2 text-white text-lg bg-white/20' shadowIntensity='lg'>
...
export default MobileIconsGlassy;
